...
const PROJECTS = [
  {
    ...
    stack: ['NestJS', 'TypeScript', 'MySQL', 'JWT', 'Swagger'],
    stackClasses: ['badge-node', 'badge-js', 'badge-mysql', 'badge-api', 'badge-git'],
    github: 'https://github.com/Yushan2008-alt/Kostan',
    demo: null,
  },
  {
    id: 2,
    ...
    year: '2026',
    title: 'Ruang Teduh',
    desc: 'Platform dukungan kesehatan mental bilingual (ID/EN) yang menjembatani krisis depresi dan pencegahan bunuh diri dengan pendekatan empatik, non-klinis, dan ramah budaya',
    highlights: ['Mood Journal & Tracker', 'Crisis SOS', 'Komunikasi Anonim', 'AI Companion Chat'],
